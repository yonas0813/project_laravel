...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jun 2024 pada 16.35
...
INSERT INTO `admins` (`id_admin`, `nama`, `username`, `password`, `created_at`, `updated_at`, `remember_token`) VALUES
(1, 'nhvuhvytf', 'asas', '222', '2024-06-06 13:44:54', '2024-06-06 13:44:54', NULL);
...
INSERT INTO `profils` (`id_profil`, `id_admin`, `sejarah`, `visi`, `misi`, `email`, `no_hp`, `created_at`, `updated_at`) VALUES
(1, 1, 'wwwwww', 'ssssss', 'aaaaaaaa', 'sss@sss.com', '23456', '2024-06-09 14:19:33', '2024-06-09 14:19:33');
...
('2d6lQSThQ0ZubEu3JsptowYtKeqTBriD4FAMWiDl', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Edg/125.0.0.0', '', 1717684098),
('6UHH5ls7oihepno0XIGBZ6BFVWXCo30ZOlwQvjxr', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Edg/125.0.0.0', '', 1717935504),
...
--
ALTER TABLE `profils`
  ADD CONSTRAINT `profils_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admins` (`id_admin`);
COMMIT;
